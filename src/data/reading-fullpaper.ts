...
NSTE-ACS with GRACE >140 or rising troponin plus dynamic ECG changes: angiography within 24 hours. GRACE 109–140 with confirmed NSTE-ACS: angiography within 72 hours. Dual antiplatelet therapy for 12 months unless bleeding risk high. High-intensity statin for all ACS unless contraindicated. Refer cardiac rehabilitation before discharge. Smoking cessation support mandatory for current/recent smokers.`,
    questions: [
      ...
      {
        id: "read-fa-1-q13",
        prompt: "According to the pathway, angiography timing for this patient should be within:",
        options: ["24 hours", "72 hours", "7 days", "Outpatient only"],
        correctIndex: 0,
        explanation:
          "Rising troponin plus dynamic ECG changes → angiography within 24 hours (even though GRACE is 128, not >140).",
      },
      {
        id: "read-fa-1-q14",
        prompt: "Dual antiplatelet therapy duration unless high bleeding risk:",
        options: ["1 month", "3 months", "6 months", "12 months"],
        correctIndex: 3,
        explanation: "DAPT for 12 months unless bleeding risk high.",
      },
      {
        id: "read-fa-1-q15",
        prompt: "Why was omeprazole started?",
        options: ["Active peptic ulcer", "GI protection", "H. pylori eradication", "Reflux only"],
        correctIndex: 1,
        explanation: "Omeprazole 20 mg daily started (GI protection).",
      },
      {
        id: "read-fa-1-q16",
        prompt: "Killip class on clerking:",
        options: ["I", "II", "III", "IV"],
        correctIndex: 0,
        explanation: "Killip class I.",
      },
      {
        id: "read-fa-1-q17",
        prompt: "Where is the patient to be admitted?",
        options: ["General ward", "CCU", "ICU only", "Home with ambulatory ECG"],
        correctIndex: 1,
        explanation: "Plan includes admit CCU.",
      },
      {
        id: "read-fa-1-q18",
        prompt: "Last month's LDL:",
        answer: "3.1 mmol/L",
        acceptedAnswers: ["3.1 mmol/L", "3.1", "3.1 mmol/l"],
        explanation: "Lipid profile last month: LDL 3.1 mmol/L.",
      },
      {
        id: "read-fa-1-q19",
        prompt: "Morphine dose given in ED:",
        answer: "5 mg IV",
        acceptedAnswers: ["5 mg IV", "5mg IV", "morphine 5 mg IV", "5 mg"],
        explanation: "Morphine 5 mg IV ×1.",
      },
      {
        id: "read-fa-1-q20",
        prompt: "Before discharge, the pathway requires referral to:",
        options: ["Dermatology", "Cardiac rehabilitation", "Orthopaedics", "Dietetics only"],
        correctIndex: 1,
        explanation: "Refer cardiac rehabilitation before discharge.",
      },
    ],
  },
  {
